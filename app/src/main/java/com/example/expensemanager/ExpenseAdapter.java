...
public class ExpenseAdapter extends RecyclerView.Adapter<ExpenseAdapter.MyViewHolder>{
    ...
    private List<ExpenseModdel> expenseModelList;
    ...
    public void add(ExpenseModdel expenseModel) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ExpenseModdel expenseModel = expenseModelList.get(position);
        holder.note.setText("Note: " + expenseModel.getNote());
        holder.category.setText("Category: " + expenseModel.getCategoty());
        ...
        holder.cardview.startAnimation(AnimationUtils.loadAnimation(holder.itemView.getContext(), R.anim.anim_k));
    }
